...
abstract class User {
    ...
    static function init($db_drvr, $db_host, $db_name, $db_user, $db_pass) {
        try {
            switch ($db_drvr) {
                case 'mysql': self::$_db = new \PDO('mysql:host=' . $db_host . ';dbname=' . $db_name, $db_user, $db_pass);
                    break;
                case 'mssql': self::$_db = new \PDO('mssql:host=' . $db_host . ';dbname=' . $db_name, $db_user, $db_pass);
                    break;
                case 'sybase': self::$_db = new \PDO('sybase:host=' . $db_host . ';dbname=' . $db_name, $db_user, $db_pass);
                    break;
                default: self::$_db = new \PDO('mysql:host=' . $db_host . ';dbname=' . $db_name, $db_user, $db_pass);
                    break;
            }
    ...
    /**
     * Return groupID and groupName.
     *
     * @return array Returns groupData.
     */
    ...
    /**
     * Return if user has specific group.
     *
